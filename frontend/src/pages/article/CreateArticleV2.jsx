...
const CreateArticleV2 = () => {
  ...
  const { darkMode, loggedInProfile, sessionToken, submitted, setSubmitted } = useStateContext()
  ...
  const createForm = async () => {
    ...
    newArticle.append('author', loggedInProfile.username)
    return newArticle
  }
...
} */}
{
  <div className={`${submit ? 'hidden' : 'block'}`}>
    ...
    <div>
      <div className={`${!sessionToken ? 'flex justify-center text-white ' : 'hidden'}`}>
        <div className='mt-20'>
