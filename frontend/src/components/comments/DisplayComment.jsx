...
/**
 * @param {string} commentID - id of parent comment
 * @param {string} userID - id of user who posted comment
 * @param {string} profileName - profile name of user who posted comment
 * @param {string} profileImage - profile image of user who posted comment
 * @param {string} comment - new comment
 * @param {string} date - timestamp
 * @param {string} replies - replies of comment
 * 
 * @return {JSX.Element} - users comment 
 */
