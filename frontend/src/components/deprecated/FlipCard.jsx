...
//! Deprecated component. Bugs not fixed.

/**
 * Card which displays an image and text on the front and rotates to show more text on the back
 * 
 * @param {string} img - Image displayed on the card
 * @param {string} imgAlt - Alt text required for the image
 * @param {string} header - Header text of the card
 * @param {string} text - Main text on front of card
 * @param {string} backText - Additional information on the back of the card
 * 
 * @returns {JSX.Element} Card which rotates on hover to display more information
 */
